        ...
        <el-form ref="vscodeForm" :model="vscodeForm" :rules="vscodeRules" auto-complete="on" label-position="left">
          ...
          <el-form-item prop="code">
            ...
            <span class="show-pwd mr30">
              <el-button :loading="vCodeBtnLoading" type="text" @click="onSendFindPwdSms" :disabled="disabledVCodeBtn">{{ vCodeBtnText }}</el-button>
            </span>
          </el-form-item>
...
import { verifyFindCodeAndModifyPwd, sendFindPwdSms } from '@/api/user'
        ...
        if (valid) {
          ...
          this.$store.dispatch('Login', { account, pwd })
            .then(() => {
              ...
              /**
               * 采销推送邮箱里的链接
               * 全集团 http://dctest.yanmiya.com:66/manager/index.html#/login?redirect=/purchase-sale-diff/company
               * 品牌 http://dctest.yanmiya.com:66/manager/index.html#/login?redirect=/purchase-sale-diff/brand
               * 商品服务类型 http://dctest.yanmiya.com:66/manager/index.html#/login?redirect=/purchase-sale-diff/goods-service-type
               */
