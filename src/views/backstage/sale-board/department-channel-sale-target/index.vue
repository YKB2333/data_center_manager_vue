  ...
  <div>
    <el-form :model="query" inline>
      ...
      <el-form-item label="渠道类型">
        <el-select v-model="query.channelCode">
          <el-option  
    ...
    >
      ...
      <el-table-column label="渠道类型" prop="channelName" width="120"></el-table-column>
...
import { 
  ...
  deleteBatchTarget,
  getChannelList
} from '@/api/backstage/department-channel-sale-target'
...
export default {
  ...
  methods: {
    ...
    async init() {
      ...
      const { result: channelList } = await getChannelList()
      ...
      // 默认第一个渠道
      this.query.channelCode = this.channelList[0].code
      this.fetchTableData()
    },
    ...
    onAdd() {
      ...
      this.dialogData.channelCode = this.query.channelCode
