          ...
          <el-tabs>
            <el-tab-pane>
              ...
              <div class="ptb10">
                ...
                <div class="row pt20">
                  ...
                  <el-button :loading="vCodeBtnLoading" size="mini" type="success" class="ml20 w120" @click="onSendFindPwdSms" :disabled="disabledVCodeBtn">{{ vCodeBtnText }}</el-button>
                </div>
            ...
            <el-tab-pane>
              ...
              <div class="row pt20">
                ...
                <el-button size="mini" type="success" class="ml20" @click="onSendFindPwdEmail" :loading="sendEmailBtnLoading">发送</el-button>
                </div>
            </el-tab-pane>
          </el-tabs>
        </div>
...
import { 
  verifyEmailTokenAndModifyPwd, verifyFindCodeAndModifyPwd,
  sendFindPwdSms, sendFindPwdEmail
} from '@/api/user'
...
export default {
  ...
  methods: {
    ...
    onSendFindPwdSms() {
      ...
      sendFindPwdSms(mobile).then(res => {
    ...
    onSendFindPwdEmail() {
      ...
      sendFindPwdEmail(email).then(res => {
    ...
    resetPasswordEmail() {
      ...
      verifyEmailTokenAndModifyPwd(this.urlToken, this.emailPwdForm.newPwd)
      .then(res => {
        // console.log(res)
    ...
    resetPasswordMobile() {
      ...
      verifyFindCodeAndModifyPwd(this.vCode, this.mobile, this.mobilePwdForm.newPwd)
      .then(res => {
        this.$alert('返回登录页？', '密码重置成功', {
          confirmButtonText: '确定',
          showClose: false,
